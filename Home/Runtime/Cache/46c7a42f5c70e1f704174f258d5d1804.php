...
<html>
  <head>
    ...
    <link href="__PUBLIC__/Css/home//bootstrap-theme.css" rel="stylesheet">
    ...
    <script src="__PUBLIC__/Js/home/sch.js"></script>
    ...
    <div class="container">
      ...
      <div class="col-sm-8 blog-main">
        <?php if(is_array($blog_list)): foreach($blog_list as $key=>$blog): ?><div class="blog-post">
            ...
            <p class="blog-post-meta"><?php echo ($blog["lastModifyTime"]); ?> by <a href="#"><i><?php echo ($blog["author"]); ?></i></a></p>
        ...
        <nav>
          <ul class="pager">
            <li style="margin-right:350px;"><a href="#">Previous</a></li>
            <li><a href="#">Next</a></li>
          </ul>
        </nav>
      </div><!-- /.blog-main -->
